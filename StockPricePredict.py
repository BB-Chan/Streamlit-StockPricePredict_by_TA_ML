...
df['Plus_di'] = pd.DataFrame(get_adx(df['High'], df['Low'], df['Close'], 14)[0])
df['Minus_di'] = pd.DataFrame(float(get_adx(df['High'], df['Low'], df['Close'], 14)[1]))
df['ADX'] = pd.DataFrame((get_adx(df['High'], df['Low'], df['Close'], 14)[2]))
